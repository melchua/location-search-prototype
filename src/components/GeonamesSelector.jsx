...
export default class GeonamesSelector extends Component {
  state = {
    results: [],
    inputValue: "",
    selectedResult: "",
      ...
      <div className="react-geonames">
        ...
        <div className="react-geonames-input-area">
          ...
          {this.state.selectedResult ? (
            <button
              className="react-geonames-clear-button"
